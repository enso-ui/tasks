    ...
    <div @mouseover="display = true"
        ...
        <label class="checkbox" v-show="!editForm">
            <input class="form-check-input mr-1"
               ...
               type="checkbox" :value="isCompleted">
        </label>
        <span v-show="!editForm" class="checklistName"
        ...
        <div v-show="editForm" class="mt-3">
            <input class="textarea" v-model="updateChecklist.name"
                      rows="2" placeholder="Add new to-do">
            <div class="mt-3">
                <button class="button is-rounded is-small is-bold mr-1 action" @click="editForm = false">
                    <span>
                        {{ i18n('Cancel') }}
                    </span>
                ...
                <button class="button is-rounded is-bold is-small is-success action" @click="update">
                    <span>
                        {{ i18n('Update') }}
                    </span>
                    <span class="icon">
        ...
        <span>
            <button @click="empty(checklist)"
                    class="ml-2 mt-1 delete is-small"
                    v-show="display &&!editForm"
            ></button>
        </span>
    </div>
...
import {faCheck, faPencilAlt, faTimes, faGripLines} from '@fortawesome/free-solid-svg-icons';
